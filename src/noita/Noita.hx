...
extern class Noita
{
    ...
    public static function EntityGetFirstComponent( entity_id:Entity, component_type_name, ?tag ):ComponentId;
    public static function EntitySetTransform( entity_id:Entity, x, ?y, ?rotation, ?scale_x, ?scale_y ):Void;
    public static function EntityGetTransform( entity_id:Entity ) -> x,y,rotation,scale_x,scale_y;
    public static function EntityAddChild( parent_id, child_id ):Void;
    public static function EntityGetAllChildren( entity_id:Entity ) -> {entity_id}|nil;
    ...
    public static function EntityGetTags( entity_id:Entity ) -> string|nil [string is comma separated];
    ...
    public static function GameGetVelocityCompVelocity( entity_id:Entity ) -> x,y;
